...
MODELS = [
    ("FLAIR\n(~6 params, CPU)",       0.691, 0.801, "#E74C3C", True),
...
DATASETS_REL = {
    "dominick":        (0.625, 0.931),
    "ercot":           (1.158, 0.742),
    "exchange_rate":   (0.880, 1.043),
    "m4_quarterly":    (0.894, 0.775),
    "m4_yearly":       (0.843, 0.941),
    "m5":              (0.351, 0.670),
    "aus_electricity": (0.470, 0.977),
    "car_parts":       (0.260, 0.743),
    "cif_2016":        (0.785, 0.791),
    "covid_deaths":    (0.087, 0.902),
    "fred_md":         (0.751, 0.431),
    "hospital":        (0.919, 0.771),
    "m1_monthly":      (0.966, 0.892),
    "m1_quarterly":    (0.886, 0.870),
    "m1_yearly":       (0.710, 0.969),
    "m3_monthly":      (0.890, 0.773),
    "m3_quarterly":    (1.027, 0.898),
    "m3_yearly":       (0.917, 1.066),
    "nn5_weekly":      (0.755, 0.873),
    "tourism_monthly": (1.008, 1.180),
    "tourism_quarterly": (1.053, 1.037),
    "tourism_yearly":  (0.988, 1.123),
    "traffic":         (0.766, 0.761),
    "weather":         (0.553, 0.852),
    "nn5":             (0.594, 0.474),
}
